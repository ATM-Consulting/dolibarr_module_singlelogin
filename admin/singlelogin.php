...
//Admin users
print '<tr class="pair"><td>'.$langs->trans("SLAdminUser").'</td>';
print '<td align="left">';
...
/*
$res=dol_include_once('/core/db/pgsql.class.php');


$buffer = file_get_contents('/home/bobby/Eclipse/workspace/dolibarr/htdocs/install/mysql/tables/llx_product_price_by_qty.sql');
//print nl2br($buffer);

print 'After convert :<BR>';
$obj=new DoliDBPgsql('pgsql','localhost','homedread','homedread','dolibarrtest');
print nl2br($obj->convertSQLFromMysql($buffer));
*/
