...
class modSingleLogin extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->picto = 'singlelogin@singlelogin'; // mypicto@mymodule
		...
		$this->langfiles = array("singlelogin@singlelogin"); // langfiles@mymodule
		// Constants
		...
		//$this->rights[$r][0] = 100551;
		//// Permission label
		//$this->rights[$r][1] = 'Admin of unlock session';
